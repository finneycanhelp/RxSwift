...
example("sequenceOf") {
    let sequenceOfFourCircles/* : Observable<String> */ = Observable.of("🔴","🔵","⚪️","㊗️")
...
example("toObservable") {
    let sequenceOfFourCircles/* : Observable<String> */ = ["🔴","🔵","⚪️","㊗️"].toObservable()
...
/*:
There is a lot more useful methods that return Observable sequences in the RxCocoa library, so check them out:
